...
# Deep Reinforcement Learning Workbench

This is a fork of the repository related to Udacity's [Deep Reinforcement Learning Nanodegree](https://www.udacity.com/course/deep-reinforcement-learning-nanodegree--nd893) program. This repository is used as a workbench for solving exercises and for experimenting concepts learned trough the nanodegree program.

The rest of this readme refers to the original Udacity repository.
